...
let tag = "△"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '768199149195624458')
...
.setTitle(`< Kayıt İşlemi Tamamlandı`)
    .addField(`<a:winstapembealev:772021868303089674> Kayıt Eden:`, `<@${message.author.id}> Tarafından Kayıt Edildi`) 
    ...
    .addField(`<a:winstapembealev:772021868303089674> Alınan Rol:`, `<@&${kayıtsız.id}> Rolleri Alındı`)
    .addField(`<a:winstayesilalev:772021962145923113> Yeni İsmin:`, `\`${tag} ${isim} | ${yas}\` Olarak Güncellendi`) 
